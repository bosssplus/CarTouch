...
// طبق توصیه‌ی بالا، vehicleDB اکنون در main.cpp با `new VehicleDB()`
// در ابتدای setup() به‌صورت دینامیک تخصیص داده می‌شود، که روی این
// هسته‌ی Arduino-ESP32 (با PSRAM فعال) به‌طور خودکار از PSRAM
// (ESP32-S3-WROOM-1-N16R8 دارای ۸ مگابایت PSRAM است) سرو می‌شود -
// پس دیگر محدودیت سخت‌گیرانه‌ی DRAM داخلی معنی ندارد.
