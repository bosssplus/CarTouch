...
private:
    ...
    // اصلاحیه: rate-limit سطح پایین روی فرمان‌های کنترلی. حتی اگر یک
    // مسیر ورودی جدید (مثلاً API دیگری در آینده) بدون rate-limit بالاتر
    // اضافه شود، این لایه از ارسال فرمان‌های فیزیکی با سرعت خطرناک به
    // موتور شیشه/قفل جلوگیری می‌کند.
